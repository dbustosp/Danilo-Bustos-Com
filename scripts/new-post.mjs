 ...
 *
 *   node scripts/new-post.mjs "Título" --category notas [--lang en] [--date YYYY-MM-DD] [--featured] [--origin URL] [--mdx]
 *
...
const CATEGORIES = ['ingenieria', 'enterprise', 'notas'];
...
if (!title || !flag('category')) {
  console.error('Uso: node scripts/new-post.mjs "Título" --category <ingenieria|enterprise|notas> [--lang en] [--date YYYY-MM-DD] [--featured] [--origin URL] [--mdx]');
  process.exit(1);
}
